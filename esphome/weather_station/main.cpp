...
bool update_weather()
{
  ...
  HTTPClient http;
  http.begin("http://api.openweathermap.org/data/2.5/weather?q=Cantley,CA&APPID=7765ec4d06e62d9e777dc688ae0ef956"); //HTTP
  ...
  http2.begin("http://api.openweathermap.org/data/2.5/forecast?q=Cantley,CA&APPID=7765ec4d06e62d9e777dc688ae0ef956&cnt=20"); //HTTP
...
void start_wifi()
{
  ...
  esid="39";
  pass="thirtyninecheminriver";
  ntp="0.ca.pool.ntp.org";
...
void draw_time ()
{
  ...
  if (this_hour<10)
    display.print("0"+String(this_hour));
  else
    display.print(this_hour);

  display.print(":");

  // Minutes
  if (this_minute<10)
    display.print("0"+String(this_minute));
  else
    display.print(this_minute);
